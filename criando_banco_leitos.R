...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_24_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "25-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(67,35,20,33,3,7,10,0,12,0,15),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(2,6,2,0,1,1,2,0,1),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     leitos = c(69,112,87,59,47,56,40,20,30,10,4,16,10,10,47,7),
                     internados = c(63,75,73,31,27,44,33,19,18,8,4,16,10,9,38,6),
                     covid = c(7,17,0,2,0,3,10,0,0,0,0,2,0,0,0,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_25_05.csv")
