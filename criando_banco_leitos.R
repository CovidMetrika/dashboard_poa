...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_13_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "14-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(56,21,20,18,10,12,4,9,7,14,16),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,5,2,0,2,0,1,0,1),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(49,66,79,45,29,40,30,15,16,8,3,16,9,7,28,7),
                     covid = c(8,11,0,3,0,4,7,0,0,0,0,2,0,0,0,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_14_05.csv")
