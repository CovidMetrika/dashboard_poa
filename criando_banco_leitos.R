...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_02_09.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "03-09-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(61,86,29,34,9,22,0,8,21,9,21),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,7,1,0,4,1,2,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(43,160,75,75,143,59,60,37,40,13,39,20,20,20,6,20,10),
                     internados = c(38,137,74,75,122,52,55,32,33,10,38,17,16,14,6,20,4),
                     leitos_covid = c(2,80,44,40,75,20,30,17,18,3,0,3,0,6,0,6,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_03_09.csv")
