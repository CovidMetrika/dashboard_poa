...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_23_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "24-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(46,36,19,16,16,12,0,14,19,0,15),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(1,5,0,0,0,0,0,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(48,128,75,56,87,59,60,40,20,7,39,20,20,10,6,10,10),
                     internados = c(31,96,57,49,71,42,52,32,19,5,38,18,15,10,3,10,5),
                     covid = c(0,42,25,12,10,7,4,4,1,0,0,0,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/leitos_poa_24_06.csv")
