...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_16_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "17-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(65,76,27,30,9,17,4,0,14,16,14),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,15,2,0,5,4,1,0,1),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(41,160,75,64,143,59,60,40,32,18,39,20,20,10,6,19,10),
                     internados = c(37,149,70,64,119,42,56,33,29,13,39,18,18,9,3,19,8),
                     leitos_covid = c(4,90,35,37,61,20,33,19,17,7,1,3,0,0,0,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_17_08.csv")
