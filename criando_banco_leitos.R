...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_15_10.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "16-10-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(86,98,21,47,39,17,0,3,10,10,31),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,2,2,0,2,3,1,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(46,135,75,62,121,59,60,40,42,8,29,20,20,18,6,20,10),
                     internados = c(45,114,70,59,88,54,46,39,38,6,29,16,16,16,3,18,8),
                     leitos_covid = c(1,58,28,30,29,21,17,21,10,2,0,4,0,8,0,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_16_10.csv")
