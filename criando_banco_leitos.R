...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_31_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "01-09-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(44,68,30,24,9,20,6,16,15,9,29),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(7,2,1,0,3,2,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(42,160,75,75,143,59,60,39,36,15,39,20,20,13,6,20,10),
                     internados = c(38,142,71,75,125,52,57,36,31,11,38,19,17,13,5,20,6),
                     leitos_covid = c(2,85,43,40,69,21,30,17,16,4,1,4,0,5,0,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_01_09.csv")
