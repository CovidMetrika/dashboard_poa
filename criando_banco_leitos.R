...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_12_01.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "13-01-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(77,73,24,29,22,18,0,5,19,0,16),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,8,0,0,6,4,0,1,2),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(44,145,75,58,121,59,60,40,44,15,39,40,16,18,6,10,10),
                     internados = c(40,127,70,58,91,51,53,39,34,11,39,34,14,14,4,8,7),
                     leitos_covid = c(5,60,37,38,43,8,19,19,16,6,0,16,1,7,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_13_01.csv")
