...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_20_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "21-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(67,38,22,23,15,8,0,8,15,9,3),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,4,4,0,0,0,1,1,1),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(54,75,78,47,26,52,38,19,18,9,4,15,9,9,38,7),
                     covid = c(9,16,0,1,0,3,14,0,0,0,0,2,0,0,0,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_21_05.csv")
