...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_21_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "22-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(69,30,21,17,15,5,4,0,10,8,17),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,3,2,0,1,0,0,2,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(56,77,81,45,26,49,33,18,18,9,4,16,9,8,43,5),
                     covid = c(8,19,0,2,0,3,12,0,0,0,0,2,0,0,0,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_22_05.csv")
