...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_11_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "12-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(67,77,19,16,9,18,12,7,7,0,24),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,11,1,0,3,1,2,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(40,160,75,63,143,59,60,40,32,18,39,20,20,10,6,17,10),
                     internados = c(35,139,72,63,124,50,54,32,29,17,39,19,14,7,3,16,8),
                     covid = c(4,88,36,37,70,24,30,18,14,7,0,3,0,0,0,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_12_08.csv")
