...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_15_04_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "16-04-2021" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(58,197,59,66,149,59,60,40,58,18,39,56,20,38,6,20,10,16),
                     internados = c(43,176,85,86,132,70,60,44,55,10,41,41,18,33,9,20,11,10),
                     leitos_covid = c(12,107,79,79,88,33,45,19,55,10,7,2,3,32,0,19,6,10),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(38,11,3,2,11,15,8),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_16_04_21.csv")
