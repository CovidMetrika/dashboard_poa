...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_20_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "21-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(49,55,17,14,16,8,8,10,0,15,23),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,2,1,0,3,0,0,3,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     leitos = c(75,123,87,59,29,56,40,20,20,10,6,20,10,10,55,7),
                     internados = c(68,96,62,43,29,43,32,18,11,7,3,20,10,6,48,6),
                     covid = c(24,38,6,2,0,11,6,0,0,0,0,1,0,0,4,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_21_06.csv")
