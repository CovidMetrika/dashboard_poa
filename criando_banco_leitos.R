...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_04_09.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "05-09-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(49,42,10,37,9,16,3,8,13,0,20),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,5,1,0,5,1,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(47,160,75,75,143,59,60,40,40,13,39,20,20,20,6,20,10),
                     internados = c(42,145,74,75,120,50,53,35,31,10,36,15,16,14,5,19,7),
                     leitos_covid = c(2,84,44,40,68,19,29,14,17,4,0,3,0,7,0,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_05_09.csv")
