...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_28_03_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "29-03-2021" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(66,197,59,66,165,59,70,39,70,18,39,56,22,30,6,20,10,16),
                     internados = c(51,198,86,106,158,74,76,51,83,17,42,56,22,30,10,20,12,14),
                     leitos_covid = c(18,123,76,103,123,42,72,41,74,16,1,48,10,30,1,20,11,14),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(29,7,6,6,4,13,10),
                    leitos_covid = c(1,0,0,0,2,2,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_29_03_21.csv")
