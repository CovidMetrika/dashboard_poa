...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_02_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "03-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(48,79,13,17,9,25,8,13,0,9,21),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,5,3,0,9,3,0,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(39,152,75,62,143,59,60,40,28,14,39,20,20,10,6,20,8),
                     internados = c(36,140,70,61,115,46,57,37,22,12,39,20,15,8,4,20,8),
                     covid = c(2,80,38,36,56,23,32,17,12,6,0,4,0,0,1,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_03_08.csv")
