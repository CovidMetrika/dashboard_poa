...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_13_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "14-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(54,51,20,22,9,23,12,11,6,0,18),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,8,0,0,4,4,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(41,160,75,69,143,59,60,40,32,18,39,20,20,10,6,20,10),
                     internados = c(39,147,69,69,123,48,54,36,29,12,38,17,18,8,5,18,8),
                     covid = c(4,89,35,39,67,23,31,20,17,6,0,3,0,0,0,4,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(31,11,8,6,7,8,7),
                    covid = c(1,0,0,0,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_14_08.csv")
