...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_09_01.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "10-01-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(57,89,13,40,22,15,0,13,6,0,30),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(6,2,2,0,4,1,0,0,1),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(40,145,75,61,121,59,60,40,44,15,39,40,16,18,6,10,10),
                     internados = c(38,119,70,61,90,52,57,37,35,14,37,31,14,16,5,8,8),
                     leitos_covid = c(3,51,36,38,36,12,23,17,19,8,0,12,1,8,0,2,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_10_01.csv")
