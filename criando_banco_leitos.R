...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_19_03_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "20-03-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(76,74,21,32,22,64,22,41,55,27,63),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,4,2,0,4,0,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(65,167,87,66,162,59,70,40,68,16,45,56,23,20,6,20,10,16),
                     internados = c(65,205,86,106,177,79,78,58,73,15,45,56,27,19,8,20,11,13),
                     leitos_covid = c(21,130,82,105,145,47,68,44,71,15,10,48,11,10,2,19,10,13),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(34,9,5,4,4,13,8),
                    leitos_covid = c(0,1,0,0,1,3,1),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_20_03_21.csv")
