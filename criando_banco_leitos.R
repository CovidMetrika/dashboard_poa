...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_27_09.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "28-09-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(72,90,25,33,21,11,6,7,21,0,29),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,5,1,0,8,1,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(40,161,75,69,135,59,60,40,41,8,34,20,20,18,6,15,10),
                     internados = c(36,135,73,69,98,50,58,37,35,7,31,19,19,16,5,15,5),
                     leitos_covid = c(2,69,28,39,44,19,29,15,12,2,0,5,0,8,0,10,1),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(29,12,7,4,9,9,8),
                    leitos_covid = c(0,1,0,0,1,0,1),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_28_09.csv")
