...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_22_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "23-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(39,43,21,18,16,10,2,13,18,12,22),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(1,3,0,0,0,0,1,1,1),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(47,128,75,56,87,59,60,40,20,7,39,20,20,10,6,10,10),
                     internados = c(25,96,65,46,72,46,52,26,18,3,35,19,13,8,4,10,3),
                     covid = c(2,45,27,12,7,8,4,4,2,0,0,0,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/leitos_poa_23_06.csv")
