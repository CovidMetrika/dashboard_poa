...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_12_12.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "13-12-2020" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(46,132,75,61,121,59,60,40,42,15,29,37,20,18,6,10,10),
                     internados = c(32,120,71,61,108,54,60,39,38,13,28,35,15,16,5,10,7),
                     leitos_covid = c(2,65,28,32,49,18,24,20,20,6,0,18,1,8,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_13_12.csv")
