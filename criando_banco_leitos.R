...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_29_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "30-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(42,54,24,17,9,15,3,0,14,4,29),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,3,3,0,4,2,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(42,160,75,75,143,59,60,40,36,15,39,20,20,11,6,20,10),
                     internados = c(38,136,73,75,121,48,56,37,30,11,38,18,20,11,5,19,7),
                     leitos_covid = c(4,83,42,37,65,22,32,16,15,5,1,2,0,3,0,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_30_08.csv")
