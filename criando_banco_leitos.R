...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_21_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "22-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(65,60,27,36,19,23,2,18,12,8,32),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(7,4,4,0,3,1,2,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(41,150,75,64,126,49,60,40,20,10,39,20,20,10,6,20,6),
                     internados = c(38,144,71,63,103,43,50,34,19,9,35,15,16,7,6,19,6),
                     covid = c(2,83,41,32,48,23,19,13,9,5,0,3,0,0,1,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_22_07.csv")
