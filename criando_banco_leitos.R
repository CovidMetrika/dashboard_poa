...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_27_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "28-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(64,23,20,31,2,6,8,10,12,10,17),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(2,4,2,0,1,0,1,2,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     leitos = c(69,112,87,59,47,56,40,20,20,10,4,16,10,10,47,7),
                     internados = c(59,76,80,47,26,52,33,20,14,10,3,15,9,5,38,5),
                     covid = c(8,17,0,4,0,4,8,0,0,0,0,1,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/leitos_poa_28_05.csv")
