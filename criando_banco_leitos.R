...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_14_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "15-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(42,19,18,29,8,13,2,16,12,0,15),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,3,1,0,2,1,0,0,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(53,72,75,50,28,49,31,16,15,9,3,14,9,7,29,7),
                     covid = c(9,14,0,3,0,0,7,0,0,0,0,2,0,0,0,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_15_05.csv")
