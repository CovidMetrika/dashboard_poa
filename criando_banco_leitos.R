...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_28_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "29-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(85,64,22,44,39,8,17,16,18,15,26),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(7,5,6,0,3,2,4,0,2),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(46,132,75,62,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(43,116,71,62,100,51,59,38,37,5,28,17,16,14,5,10,8),
                     leitos_covid = c(4,62,28,30,40,13,29,19,23,0,0,4,0,9,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_29_11.csv")
