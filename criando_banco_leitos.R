...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_28_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "29-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(214,21,14,31,13,17,5,8,8,0,22),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,4,0,0,1,0,0,1,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(57,72,80,48,27,49,32,20,14,9,3,14,10,7,45,5),
                     covid = c(9,16,0,4,0,2,8,0,0,0,0,2,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/leitos_poa_29_05.csv")
