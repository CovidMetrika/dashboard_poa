...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_24_03_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "25-03-2021" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(61,197,59,66,165,59,70,40,70,18,39,56,23,30,6,20,10,16),
                     internados = c(64,201,86,106,183,76,76,58,81,12,48,56,22,29,8,20,13,17),
                     leitos_covid = c(25,131,80,106,144,42,70,48,71,12,3,50,10,29,0,20,12,17),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_25_03_21.csv")
