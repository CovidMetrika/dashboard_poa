...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_10_03_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "11-03-2021" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(67,167,85,66,163,59,70,40,60,16,39,56,20,30,6,20,10,19),
                     internados = c(67,194,84,106,165,79,78,51,73,16,38,56,19,25,5,20,9,17),
                     leitos_covid = c(25,126,44,107,126,55,71,38,64,15,2,56,9,25,1,19,0,17),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(30,8,5,8,6,11,6),
                    leitos_covid = c(2,0,0,0,2,2,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_11_03_21.csv")
