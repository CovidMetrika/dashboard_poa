...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_20_01.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "21-01-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(81,71,17,39,22,15,11,9,20,0,27),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(10,5,3,0,5,2,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(41,145,75,59,121,59,60,40,44,15,39,40,16,18,6,10,10),
                     internados = c(38,122,69,59,92,49,55,36,31,10,36,32,14,13,3,9,8),
                     leitos_covid = c(8,59,35,35,38,14,20,15,13,5,0,23,0,5,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_21_01.csv")
