...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_08_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "09-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(98,81,25,44,39,11,0,11,10,11,28),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,11,1,0,8,3,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(39,121,75,65,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(37,105,72,65,91,53,59,29,36,8,29,16,14,15,5,10,9),
                     leitos_covid = c(2,50,28,30,32,25,16,13,14,3,1,4,0,9,0,1,1),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_09_11.csv")
