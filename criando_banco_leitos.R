...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_07_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "08-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(76,81,25,44,39,7,15,28,11,10,28),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,7,3,0,6,1,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(39,121,75,65,59,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(37,105,72,65,48,53,57,29,36,8,29,14,12,15,4,10,7),
                     leitos_covid = c(2,50,28,30,20,25,18,13,14,1,1,5,0,9,0,1,1),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_08_11.csv")
