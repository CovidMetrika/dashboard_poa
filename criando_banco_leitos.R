...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_26_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "27-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(32,21,15,13,16,13,0,7,16,8,5),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,3,2,0,2,1,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(48,133,75,56,87,59,55,40,21,7,39,20,20,10,6,10,10),
                     internados = c(30,100,55,50,64,34,41,34,17,6,39,18,13,9,4,10,7),
                     covid = c(0,49,27,12,9,9,8,6,2,1,0,1,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/leitos_poa_27_06.csv")
