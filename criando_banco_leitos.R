...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_01_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "02-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(34,58,17,14,9,22,8,12,0,5,15),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,3,0,0,3,2,6,1,1),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(40,152,75,62,143,59,60,40,28,14,39,20,20,10,6,20,7),
                     internados = c(33,142,71,61,110,46,57,36,25,14,38,20,20,9,4,20,7),
                     covid = c(5,84,42,34,55,24,32,16,13,2,0,3,0,1,1,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_02_08.csv")
