...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_09_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "10-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(58,46,22,30,16,20,4,15,10,4,20),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(2,9,3,0,3,2,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(48,142,75,62,101,49,60,40,24,7,39,20,20,10,6,10,10),
                     internados = c(37,122,70,56,81,38,54,31,18,7,38,17,14,10,2,9,7),
                     covid = c(2,70,41,19,27,19,10,11,5,3,0,2,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_10_07.csv")
