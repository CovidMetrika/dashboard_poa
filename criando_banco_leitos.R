...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_03_03_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "04-03-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(75,77,17,23,22,38,22,33,51,19,50),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,5,1,0,2,3,0,0,1),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(67,167,85,66,150,59,70,40,57,18,44,56,16,20,6,20,10,19),
                     internados = c(65,185,82,86,143,79,74,40,64,16,43,51,14,23,4,20,10,12),
                     leitos_covid = c(21,113,42,84,97,42,46,27,64,13,4,49,3,16,1,19,0,12),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_04_03_21.csv")
