...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_20_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "21-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(71,66,18,17,16,23,2,10,15,16,38),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,7,2,0,8,3,4,2,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(42,150,75,64,119,49,60,40,24,10,39,20,20,10,6,19,6),
                     internados = c(39,143,69,64,99,41,53,34,22,10,37,17,18,9,5,19,5),
                     covid = c(2,84,39,31,47,22,19,10,10,7,1,2,0,0,0,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_21_07.csv")
