...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_19_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "20-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(41,34,17,12,16,15,3,6,11,0,21),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,1,1,0,4,0,1,1,1),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     leitos = c(75,118,87,59,29,56,40,20,20,10,6,20,10,10,55,7),
                     internados = c(68,98,67,49,29,48,32,19,10,10,4,18,10,5,42,6),
                     covid = c(24,35,6,2,0,10,5,1,0,0,0,1,0,0,5,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_20_06.csv")
