...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_26_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "27-11-2020" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(45,132,75,57,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(45,121,71,57,115,57,60,38,37,5,28,17,17,13,5,9,8),
                     leitos_covid = c(5,62,27,28,48,14,24,19,19,0,0,2,0,7,0,1,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(34,11,9,5,10,10,6),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_27_11.csv")
