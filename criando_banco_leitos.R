...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_14_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "15-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(73,95,21,29,39,17,21,17,4,10,23),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(8,7,1,0,4,2,1,0,2),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(38,121,75,56,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(36,110,73,54,94,55,60,36,39,6,29,14,13,16,5,9,8),
                     leitos_covid = c(4,50,28,27,33,22,21,18,16,3,0,2,1,9,0,0,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(32,13,4,6,11,10,5),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_15_11.csv")
