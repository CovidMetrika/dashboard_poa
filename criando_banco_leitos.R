...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_09_03_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "10-03-2021" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(67,167,85,66,157,59,70,40,60,14,39,56,20,25,6,20,10,19),
                     internados = c(67,193,84,106,162,79,80,50,73,13,39,56,19,23,5,20,10,15),
                     leitos_covid = c(25,124,45,107,120,55,64,35,64,13,2,56,9,17,1,19,1,15),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(31,10,5,8,3,11,6),
                    leitos_covid = c(2,1,0,0,0,2,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_10_03_21.csv")
