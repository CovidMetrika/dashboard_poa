...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_21_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "22-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(43,38,16,16,16,17,8,17,9,0,25),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(1,6,1,0,1,0,1,2,1),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     leitos = c(75,128,87,59,39,56,40,20,20,10,6,20,10,10,60,7),
                     internados = c(69,96,70,41,32,39,29,20,13,10,3,18,10,3,48,6),
                     covid = c(25,43,6,4,0,11,5,1,0,0,0,2,0,0,4,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_22_06.csv")
