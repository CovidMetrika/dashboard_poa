...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_06_03_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "07-03-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(83,87,15,14,22,29,22,28,64,22,47),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,4,2,0,3,5,0,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(60,167,85,66,151,59,70,40,60,14,44,56,20,20,6,20,10,19),
                     internados = c(58,187,84,96,156,79,77,43,72,13,44,56,17,23,6,20,10,16),
                     leitos_covid = c(21,118,44,95,113,47,68,33,60,12,1,49,7,16,1,20,0,16),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_07_03_21.csv")
