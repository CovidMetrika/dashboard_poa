...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_14_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "15-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(62,64,20,33,16,18,6,0,15,11,23),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,2,1,0,0,2,1,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(48,152,75,62,101,59,60,40,24,10,39,20,20,10,6,20,10),
                     internados = c(40,129,71,57,84,42,54,36,19,5,38,20,14,7,4,14,8),
                     covid = c(2,75,44,26,40,10,10,10,6,4,0,4,0,0,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_15_07.csv")
