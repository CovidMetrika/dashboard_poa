...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_18_09.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "19-09-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(80,83,30,37,32,8,3,14,19,3,23),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,3,1,0,4,2,0,0,2),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(41,160,75,72,135,59,60,39,42,10,39,20,20,18,6,20,10),
                     internados = c(37,136,69,72,113,57,58,31,37,6,33,19,13,13,5,16,5),
                     leitos_covid = c(1,71,40,40,54,24,27,12,15,3,0,5,0,5,0,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_19_09.csv")
