...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_19_04_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "20-04-2021" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(58,193,87,66,142,59,60,40,58,18,39,56,16,38,6,20,10,15),
                     internados = c(51,160,84,81,124,68,61,47,44,10,33,43,24,32,5,20,10,11),
                     leitos_covid = c(14,96,77,70,79,33,43,21,36,10,1,28,0,31,0,20,9,11),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_20_04_21.csv")
