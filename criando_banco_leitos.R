...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_30_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "31-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(39,59,13,43,9,14,3,10,0,8,33),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,3,0,0,2,3,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(42,160,75,73,143,59,58,40,36,15,39,20,20,11,6,20,10),
                     internados = c(36,137,72,73,115,50,58,38,31,10,38,19,16,11,4,20,8),
                     leitos_covid = c(2,87,42,37,64,20,31,17,16,4,1,2,0,3,0,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_31_08.csv")
