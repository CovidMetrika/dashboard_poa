...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_07_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "08-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(52,44,18,20,16,25,6,17,11,13,33),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,6,4,0,3,0,0,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     internados = c(29,120,69,55,85,36,46,33,21,6,37,17,11,10,5,10,9),
                     covid = c(1,63,39,19,26,19,7,9,7,2,0,0,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_08_07.csv")
