...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_19_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "20-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(70,38,24,15,15,14,5,0,12,9,15),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,5,0,0,3,0,0,2,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(59,73,71,48,27,52,36,15,16,9,4,15,9,9,38,7),
                     covid = c(8,16,0,1,0,3,14,0,0,0,0,2,0,0,0,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_20_05.csv")
