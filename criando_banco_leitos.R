...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_29_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "30-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(63,80,30,42,39,8,17,13,23,23,42),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,15,2,0,5,2,0,0,1),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(40,132,75,62,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(40,116,72,62,100,51,56,37,37,7,28,20,15,14,5,6,8),
                     leitos_covid = c(4,62,27,30,40,13,31,20,23,0,0,6,0,9,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_30_11.csv")
