...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_30_09.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "01-10-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(102,82,35,44,39,12,25,0,0,0,29),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(8,11,2,0,4,1,0,0,1),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(41,146,75,72,135,59,60,40,42,8,29,20,20,18,6,14,10),
                     internados = c(40,125,70,72,99,54,58,37,36,4,29,14,14,16,4,14,6),
                     leitos_covid = c(2,63,26,42,39,21,24,16,16,2,0,2,0,8,0,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_01_10.csv")
