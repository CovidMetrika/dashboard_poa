...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_05_02.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "06-02-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(86,66,12,48,22,17,11,16,11,14,20),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(46,145,75,63,121,59,60,40,42,8,39,40,16,18,6,10,10),
                     internados = c(30,124,71,63,92,50,59,35,32,8,36,33,14,18,3,9,6),
                     leitos_covid = c(7,63,38,39,35,13,21,18,15,3,0,13,0,10,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_06_02.csv")
