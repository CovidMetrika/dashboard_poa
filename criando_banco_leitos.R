...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_19_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "20-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(50,70,21,31,16,22,0,16,15,17,29),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,6,2,0,4,0,5,2,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(45,150,75,62,109,49,60,40,23,10,39,20,20,10,6,20,6),
                     internados = c(38,143,70,56,102,39,50,32,21,10,37,16,18,9,5,20,6),
                     covid = c(1,87,41,29,47,21,20,10,10,6,1,1,0,0,0,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_20_07.csv")
