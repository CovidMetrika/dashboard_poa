...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_01_09.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "02-09-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(63,89,30,24,9,19,10,0,20,17,27),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(7,1,1,0,3,2,1,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(43,160,75,75,143,59,60,39,36,13,39,20,20,13,6,20,10),
                     internados = c(40,142,71,75,124,52,57,34,31,9,37,19,17,13,5,20,5),
                     leitos_covid = c(2,85,43,40,70,21,29,19,16,4,1,4,0,5,0,8,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(30,9,5,4,7,11,5),
                    leitos_covid = c(1,0,0,0,0,2,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_02_09.csv")
