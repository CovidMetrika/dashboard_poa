...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_24_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "25-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(75,67,22,29,9,13,3,0,21,11,27),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,6,0,0,7,4,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(43,160,75,72,143,59,60,38,36,14,39,20,20,18,6,19,10),
                     internados = c(39,148,72,72,120,49,60,35,30,8,34,18,14,9,1,19,8),
                     leitos_covid = c(2,87,25,35,60,20,31,16,17,4,1,3,0,1,0,8,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(27,11,7,7,5,10,5),
                    leitos_covid = c(1,0,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_25_08.csv")
