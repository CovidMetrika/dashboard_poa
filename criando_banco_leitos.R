...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_14_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "15-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(34,33,24,17,15,16,4,14,13,0,17),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(1,6,0,0,3,0,0,1,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(63,85,68,43,29,50,29,20,12,8,4,13,10,7,51,5),
                     covid = c(19,32,8,2,0,7,4,0,0,0,0,1,0,1,4,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_15_06.csv")
