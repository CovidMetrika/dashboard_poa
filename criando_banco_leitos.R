...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_17_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "18-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(36,58,21,18,13,17,9,10,8,0,22),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(1,4,0,0,3,1,8,2,1),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     leitos = c(75,118,87,59,29,56,40,20,20,10,6,16,10,10,55,7),
                     internados = c(62,93,74,47,29,50,29,17,10,10,3,13,10,5,45,6),
                     covid = c(16,32,7,2,0,10,4,0,0,0,0,0,0,0,4,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_18_06.csv")
