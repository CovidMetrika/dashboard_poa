...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_27_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "28-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(57,57,21,29,9,13,3,18,25,3,19),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(7,3,0,0,4,5,1,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(44,160,75,73,143,59,60,40,36,15,39,20,20,11,6,20,10),
                     internados = c(37,147,72,73,120,46,57,34,26,11,37,19,16,11,5,19,8),
                     leitos_covid = c(3,83,41,37,69,16,30,16,14,5,1,3,0,3,0,8,2),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_28_08.csv")
