...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_27_10.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "28-10-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(98,81,20,43,39,8,0,13,11,12,8),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(6,11,1,0,3,1,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(41,121,75,56,127,59,60,40,42,9,29,20,20,18,6,10,10),
                     internados = c(36,109,72,56,95,52,60,36,42,9,29,16,16,17,5,7,4),
                     leitos_covid = c(1,50,28,32,31,23,18,18,12,2,1,7,1,10,0,0,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(37,10,7,6,10,15,6),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_28_10.csv")
