...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_10_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "11-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(32,20,24,12,9,6,10,10,15,7,8),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,6,1,0,3,0,0,0,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(62,81,62,50,29,50,31,18,12,10,6,10,10,4,47,5),
                     covid = c(16,28,5,2,0,9,3,0,0,0,0,0,0,1,4,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_11_06.csv")
