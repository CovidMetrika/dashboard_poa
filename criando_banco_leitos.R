...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_17_12.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "18-12-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(72,69,23,39,22,12,17,34,13,13,29),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(8,6,6,0,5,2,3,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(39,144,75,60,121,59,60,38,44,15,39,35,20,18,6,10,10),
                     internados = c(35,131,71,60,106,47,58,38,35,13,39,33,12,17,5,9,9),
                     leitos_covid = c(1,73,36,37,51,13,26,18,17,7,0,18,0,10,0,0,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(29,11,4,7,8,10,4),
                    leitos_covid = c(0,0,0,0,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_18_12.csv")
