...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_29_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "30-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(32,23,15,30,16,9,4,8,12,7,21),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,4,3,0,0,3,1,0,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(53,78,76,46,28,46,30,20,14,9,0,14,10,6,43,5),
                     covid = c(11,18,2,4,0,4,8,0,0,0,0,2,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/leitos_poa_30_05.csv")
