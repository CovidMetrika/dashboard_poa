...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_12_05.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "13-05-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(56,13,19,35,5,8,7,10,15,0,10),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(2,2,0,0,1,0,1,0,1),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(56,68,82,43,27,37,30,17,16,8,3,13,10,9,33,7),
                     covid = c(8,13,0,3,0,4,8,0,0,0,0,1,0,0,0,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_13_05.csv")
