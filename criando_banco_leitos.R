...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_18_12.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "19-12-2020" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(43,144,75,62,121,59,60,40,44,15,39,35,20,18,6,10,10),
                     internados = c(36,133,71,62,106,45,59,38,31,13,38,34,12,17,5,9,9),
                     leitos_covid = c(0,78,46,40,50,12,27,21,17,7,1,18,0,10,0,6,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_19_12.csv")
