...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_18_01.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "19-01-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(76,74,22,31,22,16,11,16,11,0,20),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(8,7,0,0,4,2,0,0,2),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(42,145,75,58,121,59,60,40,44,15,39,40,16,18,6,10,10),
                     internados = c(28,120,71,58,86,48,56,32,32,13,36,36,12,15,5,9,8),
                     leitos_covid = c(5,60,37,36,36,12,19,15,14,4,0,18,0,7,0,1,1),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(34,10,8,7,10,11,5),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_19_01.csv")
