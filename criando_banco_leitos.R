...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_31_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "01-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(33,58,14,14,9,12,8,0,9,0,27),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,2,1,0,3,4,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(44,152,75,62,143,59,60,40,28,14,39,20,20,10,6,20,7),
                     internados = c(32,138,71,57,111,46,55,31,25,14,38,19,19,9,4,20,7),
                     covid = c(4,81,42,32,55,26,19,15,11,9,0,4,0,1,1,8,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_01_08.csv")
