...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_08_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "09-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(41,58,12,15,9,19,8,10,2,0,24),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,5,0,0,1,2,1,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(40,160,75,63,143,59,60,40,31,18,39,20,20,10,6,14,10),
                     internados = c(35,145,69,63,125,46,51,37,27,17,39,17,17,9,2,16,8),
                     covid = c(2,89,37,38,73,22,24,20,12,8,0,2,0,0,0,7,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_09_08.csv")
