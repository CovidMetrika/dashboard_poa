...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_23_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "24-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(91,81,34,36,39,23,2,20,24,0,33),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(9,8,5,0,5,1,0,0,2),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(42,129,75,59,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(42,118,73,59,100,57,60,36,37,5,28,17,13,17,4,7,10),
                     leitos_covid = c(5,58,27,29,36,18,24,20,18,0,0,5,0,10,0,1,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(31,10,8,7,7,12,10),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_24_11.csv")
