...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_30_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "31-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(45,54,23,17,9,13,11,10,9,1,21),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,7,1,0,3,4,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(43,152,75,63,143,59,60,40,28,14,39,20,20,10,6,20,7),
                     internados = c(33,144,72,63,113,48,56,34,21,14,38,20,17,9,5,19,7),
                     covid = c(1,85,40,34,53,26,23,14,10,9,0,4,0,1,1,6,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_31_07.csv")
