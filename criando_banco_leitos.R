...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_13_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "14-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(27,49,14,19,10,17,5,8,14,0,18),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,0,0,0,3,0,0,0,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(62,81,66,40,29,50,29,16,11,9,6,13,10,5,45,2),
                     covid = c(17,30,8,2,0,8,4,0,0,0,0,1,0,1,5,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_14_06.csv")
