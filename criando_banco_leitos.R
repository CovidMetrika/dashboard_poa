...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_27_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "28-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(34,43,17,15,16,11,0,0,0,0,16),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(2,7,3,0,2,0,0,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(48,133,75,56,101,59,55,40,21,7,39,20,20,10,6,10,10),
                     internados = c(28,106,62,50,61,35,39,35,17,7,37,18,14,9,4,10,5),
                     covid = c(0,52,27,12,10,13,11,6,3,1,0,2,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/leitos_poa_28_06.csv")
