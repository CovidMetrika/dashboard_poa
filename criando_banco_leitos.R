...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_08_07.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "09-07-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(62,46,22,22,16,26,1,11,17,13,23),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,16,2,0,3,1,0,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     internados = c(41,123,69,56,83,38,49,31,16,6,36,20,11,9,2,10,9),
                     covid = c(1,65,39,19,24,20,8,4,5,2,0,3,0,0,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_09_07.csv")
