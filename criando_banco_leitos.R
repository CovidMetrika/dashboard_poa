...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_01_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "02-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(100,69,24,29,39,7,7,18,0,7,26),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(5,2,0,0,6,0,3,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(45,121,75,55,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(35,106,68,55,88,46,57,29,38,8,29,15,14,12,6,8,7),
                     leitos_covid = c(2,51,24,30,27,15,18,15,13,2,1,4,0,8,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_02_11.csv")
