...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_25_01.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "26-01-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(94,72,20,37,22,13,11,22,12,15,26),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(8,4,3,0,9,2,3,0,3),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(43,145,75,58,121,59,60,40,44,15,39,40,16,18,6,10,10),
                     internados = c(40,117,70,58,80,49,59,35,35,10,35,28,13,14,5,9,9),
                     leitos_covid = c(8,58,33,37,32,12,21,15,13,4,0,16,0,7,0,0,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(35,11,7,8,8,11,6),
                    leitos_covid = c(0,0,0,0,1,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_26_01.csv")
