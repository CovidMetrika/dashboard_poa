...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_03_02.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "04-02-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(85,81,13,36,22,17,11,12,33,10,29),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(8,2,0,0,3,4,0,0,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(42,145,75,62,121,59,60,40,44,12,39,40,16,18,6,10,10),
                     internados = c(23,121,72,62,86,50,59,35,34,8,34,33,14,16,5,8,6),
                     leitos_covid = c(9,63,38,37,35,15,19,19,14,3,0,12,0,8,0,0,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(26,11,9,0,10,11,4),
                    leitos_covid = c(0,0,0,1,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_04_02.csv")
