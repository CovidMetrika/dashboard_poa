...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_18_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "19-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(46,55,19,20,16,11,7,4,12,9,25),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,5,3,0,2,1,1,1,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     internados = c(70,97,69,45,26,50,32,18,10,10,3,11,10,6,42,7),
                     covid = c(20,38,7,2,0,10,5,0,0,0,0,1,0,0,5,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_19_06.csv")
