...
leitos_antigos <- read_csv("bancos/leitos/leitos_poa_09_06.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "10-06-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(31,45,20,13,15,9,8,18,8,7,13),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(3,10,1,0,0,1,0,0,0),
...
uti_adulto <- tibble(local = c("hospital_conceicao","hospital_de_clinicas_de_porto_alegre","hospital_santa_casa","hospital_sao_lucas",
                     ...
                     leitos = c(75,112,87,59,29,56,40,20,20,10,6,16,10,10,50,7),
                     internados = c(64,76,65,46,29,48,30,18,16,10,5,11,10,3,49,5),
                     covid = c(18,26,5,2,0,9,3,0,0,0,0,0,0,0,3,1),
...
write_csv(leitos, "bancos/leitos/leitos_poa_10_06.csv")
