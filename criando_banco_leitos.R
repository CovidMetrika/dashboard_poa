...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_06_02.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "24-02-2021" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(78,68,19,40,22,29,12,28,21,20,38),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(6,3,0,0,1,3,0,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(47,163,75,66,117,59,60,40,42,14,39,40,16,20,6,10,10),
                     internados = c(42,158,73,71,112,59,60,38,42,10,37,40,12,20,5,10,10),
                     leitos_covid = c(5,90,40,57,47,29,25,25,29,10,0,28,2,10,0,3,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    internados = c(29,11,3,7,7,9,6),
                    leitos_covid = c(0,1,0,0,1,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_24_02.csv")
