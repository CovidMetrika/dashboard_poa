...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_02_11.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "03-11-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(101,81,22,27,39,7,15,12,8,10,23),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                            ...
                            internados = c(4,13,1,0,2,1,0,1,2),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(42,121,75,56,127,59,60,40,42,8,29,20,20,18,6,10,10),
                     internados = c(33,106,70,51,85,46,56,31,36,6,29,17,14,12,5,8,6),
                     leitos_covid = c(2,51,27,29,26,15,18,15,10,2,1,5,0,8,0,0,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_03_11.csv")
