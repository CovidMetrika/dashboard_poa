...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_14_04_21.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "15-04-2021" # mudar o dia
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos_total = c(58,197,59,66,159,59,60,40,66,18,39,56,20,38,6,20,10,16),
                     internados = c(45,175,84,86,135,71,64,50,53,12,39,40,19,33,7,20,12,11),
                     leitos_covid = c(13,108,78,73,91,34,46,24,50,12,5,29,0,32,0,20,6,11),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_15_04_21.csv")
