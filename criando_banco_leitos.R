...
leitos_antigos <- read_csv("bancos/leitos/base_antiga/leitos_poa_12_08.csv") %>%
  select(-semana_epidemiologica)

dia_atualizacao <- "13-08-2020" # mudar o dia
...
emergencias_adulto <- tibble(
  ...
  internados = c(64,60,22,30,9,23,12,10,23,10,18),
...
emergencias_pedia <- tibble(local = c("hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_santa_casa","hospital_sao_lucas",
                                      ...
                                      "pronto_atendimento_bom_jesus","pronto_atendimento_cruzeiro_do_sul","pronto_atendimento_lomba_do_pinheiro"),
                            leitos = c(9,16,11,4,8,6,5,9,4),
                            internados = c(5,8,1,0,2,3,2,1,0),
...
uti_adulto <- tibble(local = c("instituto_de_cardiologia","hospital_de_clinicas_de_porto_alegre","hospital_conceicao","hospital_moinhos_de_vento",
                     ...
                     leitos = c(40,160,75,67,143,59,60,40,32,18,39,20,20,10,6,16,10),
                     internados = c(38,143,72,67,124,51,50,34,27,14,38,20,20,10,5,18,7),
                     covid = c(3,89,34,39,68,22,31,20,15,8,0,5,0,0,0,8,0),
...
uti_pedia <- tibble(local = c("hospital_santa_casa","hospital_de_clinicas_de_porto_alegre","instituto_de_cardiologia",
                    ...
                    leitos = c(37,13,10,8,11,18,12),
                    internados = c(30,10,9,6,9,7,5),
                    covid = c(0,0,0,0,0,1,0),
...
write_csv(leitos, "bancos/leitos/base_antiga/leitos_poa_13_08.csv")
